<?php
/*
Plugin Name: Find Location By IP Address (Wordpress Plugin Template OOP)
Plugin URI: https://github.com/KamranSyed/Wordpress-Plugin-Template-OOP
Description: It is a Wordpress plugin to show visitors location data using Geolocation API
Version: 2.0
Author: Kamran Syed
		...
		function sc_showcity(){
			...
			if ( is_array( $response ) ) {
			  ...
			  $ret = json_decode($body, true);
				...
				?>
				<p>We welcome visitors from <?php echo $ret['city']; ?> </p>
				<?php
			}
